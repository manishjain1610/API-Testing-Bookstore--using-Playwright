...
export default class APIClient {
  ...
  async getForUser(endpoint: string, requestBody?: object, token?: string) {
    return this.invokeAPI('get', endpoint, requestBody, token);
  }

  async remove(endpoint: string, requestBody?: object, token?: string) {
    return this.invokeAPI('delete', endpoint, requestBody, token);
  }
